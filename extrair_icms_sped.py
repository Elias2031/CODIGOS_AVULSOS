...
def salvar_xlsx(resumos: List[SpedIcmsResumo], output_xlsx: Path) -> None:
    ...
    headers = [
        "arquivo", "encoding",
        "cnpj", "ie", "uf", "dt_ini", "dt_fin",
        "e110_vl_tot_debitos", "e110_vl_tot_creditos", "e110_vl_sld_credor_ant",
        "e110_vl_sld_apurado", "e110_vl_tot_ded", "e110_vl_icms_recolher",
        "e110_vl_sld_credor_transportar", "e110_deb_esp",
        "c190_vl_icms", "c190_vl_icms_st", "c190_vl_red_bc",
        "c590_vl_icms", "c590_vl_icms_st", "c590_vl_red_bc",
        "linhas_processadas",
    ]
    ws.append(headers)
    ...
    # Ajuste de largura e congelar cabeçalho
    ws.freeze_panes = "A2"
    for col_idx, h in enumerate(headers, start=1):
        ws.column_dimensions[get_column_letter(col_idx)].width = max(12, min(40, len(h) + 2))
